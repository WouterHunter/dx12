...
u32 GetFormatByteSize(DXGI_FORMAT format) {
    ...
    default:
        BREAK("Unsupported format: DXGI_FORMAT {}!", static_cast<u32>(format));
        return 0;
    }
}
...
std::string ToString(D3D12_RESOURCE_STATES state) {
    switch (state) {
    case D3D12_RESOURCE_STATE_COMMON:							 return "D3D12_RESOURCE_STATE_[COMMON|PRESENT]";
    ...
    case D3D12_RESOURCE_STATE_INDIRECT_ARGUMENT:				 return "D3D12_RESOURCE_STATE_[INDIRECT_ARGUMENT|PREDICATION]";
